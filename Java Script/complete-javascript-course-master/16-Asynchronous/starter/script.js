...
Here are your tasks:https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=52.508&longitude=13.381

PART 1
1. Create a function 'whereAmI' which takes as inputs a latitude value (lat) and a longitude value (lng) (these are GPS coordinates, examples are below).
2. Do 'reverse geocoding' of the provided coordinates. Reverse geocoding means to convert coordinates to a meaningful location, like a city and country name. Use this API to do reverse geocoding: https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${lat}&longitude=${lng}.
The AJAX call will be done to a URL with this format: . Use the fetch API and promises to get the data. Do NOT use the getJSON function we created, that is cheating 😉
...
// Promise.resolve('resloved promis 2').then(res=>{
...
/*
const lottoryPromise = new Promise(function(reslove,reject){
...
.then(img => {
  ...
  renderCountry(data[data.length>1?1:0]);
};
// whereAmI();
// console.log('hello');
...
(async function (){
  ...
  console.log(`3: fineshed getting location`)
})();
...
let myPromise = new Promise((resolve, reject) => {
  let opp = true;
  if (opp) {
    resolve('opperation successful');
  } else reject('opperation failed');
});
